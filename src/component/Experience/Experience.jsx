        ...
        >
          ...
          <div className="relative">
            ...
            {experiences.map((exp, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-7 w-2 h-2 bg-blue-400 rounded-full transform -translate-x-1/2 mt-8"></div>

                {/* Card */}
                <div className="bg-slate-800 rounded-lg p-6 hover:shadow-xl transition-shadow">
